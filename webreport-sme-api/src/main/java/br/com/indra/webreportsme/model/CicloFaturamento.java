...
@Entity
@SequenceGenerator(name="SEQ_CICLOFATURAMENTO", sequenceName="SEQ_CICLOFATURAMENTO", allocationSize=1, schema="smeapi")
@Table(name="CICLOFATURAMENTO", schema="SMEAPI")
public class CicloFaturamento {
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator="SEQ_CICLOFATURAMENTO")
	private long id;
	private String nome;
	...
	public CicloFaturamento(long id, String nome, LocalDate criacao, LocalDate modificacao) {
		super();
		this.id = id;
		this.nome = nome;
