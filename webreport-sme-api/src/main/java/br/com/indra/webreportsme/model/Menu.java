...
@Entity
@SequenceGenerator(name="SEQ_MENU", sequenceName="SEQ_MENU", allocationSize=1, schema="smeapi")
@Table(name="MENU", schema="SMEAPI")
public class Menu {
	...
	public Menu(long id, String nome, String codigo, LocalDate criacao, LocalDate modificacao) {
		super();
		this.id = id;
		this.nome = nome;
		this.codigo = codigo;
	...
	public String toString() {
		return "{id=" + id + ", nome=" + nome + ", codigo=" + codigo + ", criacao=" + criacao + ", modificacao="
				+ modificacao + "}";
	}
